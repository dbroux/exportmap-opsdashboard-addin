exportmap-opsdashboard-addin
============================

Add-in for Operations Dashboard for ArcGIS allwoing to export a map to various formats such as jpeg, gif, pdf by using a server print service task.

## Features

* Export Map Tool
* Configuration of the print service task that is used by the tool.
...
6. Select the Export Map tool, optionaly configure the print task service, and click Close.
